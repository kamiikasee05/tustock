# Copies para Facebook Groups — TUSTOCK

> Publicar en grupos de kiosqueros, almaceneros, librerías, maxiquioscos.
> Cada copy es independiente. Publicar uno por semana para no saturar.
