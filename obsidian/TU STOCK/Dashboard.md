...
Centro de comando del proyecto. Cada agente actualiza su sección.
...
- MCP Mercado Pago conectado (dev/testing/quality check)
...
- [[01-Producto/MEMORY]] — Fuente de verdad (incluye sección 9.5 MCP Mercado Pago)
- [[01-Producto/Planes y Precios]] — Planes vigentes y gating
...
- [[04-Tecnico/Endpoints]] — Listado completo de endpoints (server + cloud + monitor)
- [[04-Tecnico/Pendientes DEV]] — Lo que falta construir
- [[05-Decisiones/Historial]] — Log cronológico de decisiones
...
## 🔗 MP Suscripción (link compartido)

**Plan ID:** `27a1162efe9e47e68cd1349307b02eb2`
**Link:** `https://www.mercadopago.com.ar/subscriptions/checkout?preapproval_plan_id=27a1162efe9e47e68cd1349307b02eb2`
