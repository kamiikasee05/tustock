...
- **Próximas prioridades (orden):**
  ...
  3. 🟢 **Opción E (app Stock CSV)** — **EN DESARROLLO (2/8)**: app Stock genera CSV local + import + catálogo offline. **Fase 1 (app Kotlin) ✅ + Fase 2 (import server+web) ✅ completadas 2/8. CI APKs #43 ✅. EXE rebuild ✅. Pendiente: QA final en campo + actualizar clientes.**
