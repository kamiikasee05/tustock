...
- **Próximas prioridades (orden):**
  ...
  3. 🟢 **Opción E (app Stock CSV)** — **COMPLETADA (2/8)**: app Stock genera CSV local + import + catálogo offline. **Fase 1 (app Kotlin) ✅ + Fase 2 (import server+web) ✅ + Flujo unificado carga inicial + auditoría ✅ completadas 2/8. CI APKs #43 ✅. EXE rebuild ✅. Pendiente: punto C (precios ~7h) + QA final en campo + actualizar clientes.**
